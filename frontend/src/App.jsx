...
import getAllNotifications from './hooks/getAllNotifications'
import Notifications from './pages/Notifications'
import { setNotificationData, applyFollowUpdate } from './redux/userSlice'
export const serverUrl="https://instragram-backend-ud2s.onrender.com"
function App() {
   getCurrentUser()
   getSuggestedUsers()
   getAllPost()
...
socket?.on("followUpdate",(data)=>{
  dispatch(applyFollowUpdate(data))
})
